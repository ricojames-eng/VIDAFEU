			...
			$result = mysqli_query($conn, $sql);
			 if (mysqli_num_rows($result) > 0) {
				...
				$birthdate=$row['birthdate'];
				 ...
				 echo "<script>alert('No Connection!'); window.location = 'user.php';</script>";
			 }
...
<h1>Update Profile</h1>
	...
	<br>
		...
		<input class="btn" type="submit" value="Update">&nbsp <a href="user.php"> <input class='btn' type="button" value = "Cancel"></a>
</div>
		</form>
</div>
</div>
