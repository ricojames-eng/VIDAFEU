...
#chart-container {
    ...
    height: auto;
	  ...
	  <br></br>
	  	<form method="post">
	  		<script type="text/javascript" src="app/admin/mod_inventory/js/jquery.min.js"></script>
			<script type="text/javascript" src="app/admin/mod_inventory/js/Chart.min.js"></script>
