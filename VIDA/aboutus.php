      ...
      <div class="row offering_row">
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            ...
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Offer 1</h3></div>
              <div class="offer_text">
                <p>Description for offer</p>
              </div>
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            ...
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Offer 2</h3></div>
              <div class="offer_text">
                <p>Description for offer</p>
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            ...
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Offer 3</h3></div>
              <div class="offer_text">
                <p>Description for offer</p>
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            ...
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Offer 4</h3></div>
              <div class="offer_text">
                <p>Description for offer</p>
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            ...
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Offer 5</h3></div>
              <div class="offer_text">
                <p>Description for offer</p>
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
        ...
        <div class="col-xl-4 col-md-6">
          <div class="offer">
            ...
            <div class="offer_content text-center">
              <div class="offer_title"><h3>Offer 6</h3></div>
              <div class="offer_text">
                <p>Description for offer</p>
              </div>
            <!--   <div class="offer_button"><a href="#">discover</a></div> -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-5 col-lg-6">
            <div class="section_title">
              <div>Vida</div>
              <h1>Discover Vida International Hotel and Resort</h1>
            </div>
            <div class="discover_highlight">
              <p>Short Description about Vida International Hotel and Resort</p>
            </div>
            <div class="discover_text">
              <p>Short Description about what Vida International Hotel and Resort has.</p>
            </div>
          </div> 
        </div>
      </div>
