...
<title><?php echo isset($title) ? $title . ' | Vida International Hotel and Resort Tourist Inn' :  'Vida International Hotel and Resort Tourist Inn' ; ?></title>
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Vida International Hotel and Resort
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          From
          <address>
            <strong>Vida International Hotel </strong><br>
            Address<br>
            Address<br>
            Contact #<br>
            Email.
