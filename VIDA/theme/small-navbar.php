...
?> 
            ...
            <li class="widget-user-header bg-white">
              <div class="widget-user-image">
                <img class="img-circle" style="cursor:pointer;width:100%;height:100px;padding:0;"  data-target="#myModal" data-toggle="modal" src="<?php echo WEB_ROOT. $result->LOCATION;  ?>" alt="User Avatar">
              </div> 
              ...
              <div class="modal-content">
                ...
                <form action="" method="post"> 
                  ...
                  <div class="modal-footer">  
                         ...
                         <a style="color:#000;text-align:left;border-bottom:1px solid #fff;" 
                         href="<?php echo WEB_ROOT; ?>booking/index.php?view=logininfo">Sign Up </a>
                  </div>  
                 </form>  
              </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
